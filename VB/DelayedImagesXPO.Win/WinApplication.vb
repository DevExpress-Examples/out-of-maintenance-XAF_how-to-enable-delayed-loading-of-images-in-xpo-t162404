...
Namespace DelayedImagesXPO.Win
    ...
    Partial Public Class DelayedImagesXPOWindowsFormsApplication
        ...
        End Sub
        Private Sub DelayedImagesXPOWindowsFormsApplication_CustomizeLanguagesList(ByVal sender As Object, ByVal e As CustomizeLanguagesListEventArgs) Handles MyBase.CustomizeLanguagesList
            ...
            End If
        End Sub
        Private Sub DelayedImagesXPOWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
