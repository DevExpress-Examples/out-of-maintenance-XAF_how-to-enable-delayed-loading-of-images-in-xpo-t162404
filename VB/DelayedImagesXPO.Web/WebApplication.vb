...
Namespace DelayedImagesXPO.Web
    ...
    Partial Public Class DelayedImagesXPOAspNetApplication
        Inherits WebApplication

        Private module1 As DevExpress.ExpressApp.SystemModule.SystemModule
        Private module2 As DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule
        Private module3 As DelayedImagesXPO.Module.DelayedImagesXPOModule
        ...
        End Sub
        Private Sub DelayedImagesXPOAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
            e.Updater.Update()
            e.Handled = True
#Else
...
#End If
        ...
        Private Sub InitializeComponent()
            ...
            Me.module3 = New DelayedImagesXPO.Module.DelayedImagesXPOModule()
            DirectCast(Me, System.ComponentModel.ISupportInitialize).BeginInit()
            ' 
            ' DelayedImagesXPOAspNetApplication
            ' 
            Me.ApplicationName = "DelayedImagesXPO"
